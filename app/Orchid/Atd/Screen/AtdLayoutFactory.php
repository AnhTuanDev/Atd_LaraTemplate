...
namespace App\Orchid\Atd\Screen;
...
use App\Orchid\Atd\Screen\Layouts\AtdColumns;
...
class AtdLayoutFactory
{
     ...
     * @return Columns
     */
    public static function columns(array $layouts): AtdColumns
    {
        //return new class($layouts) extends Columns {
        return new class($layouts) extends AtdColumns {
        };
    }
