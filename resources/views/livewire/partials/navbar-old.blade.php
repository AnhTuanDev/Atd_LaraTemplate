                ...
                @foreach($mainMenu as $menu) 
                    ...
                    <div class="relative">
                        ...
                        <div x-show="subMenu == {{ $menu->id }}"
                             ...
                             class="absolute w-64 p-6 left-0 top-[100%] on-top 
                                    bg-primary-main space-y-4 shadow-lg"
                             style="display: none">

                                    @foreach($menu->child as $child) 
                                    <a href="{{ route('home') }}" class="inline-flex items-center hover:text-secondary-dark active:text-indigo-500 duration-200 hover:font-bold text-md md:text-lg">
                                        {{ $child->name }}
                                    </a>
                                    @endforeach
                        </div>
