<section class="content">
    ...
    <div class="w-full max-w-7xl mx-auto p-5 md:flex md:space-x-5">
        ...
        <div class="w-full md:w-1/2 rounded-md">
            <div class="text-primary-text p-4 drop-shadow-lg rounded-md border border-primary-dark p-5">
                @if($cartContent)
        ...
        <div 
            ...
            border-primary-dark md:w-1/2 mt-4 md:mt-0 p-4 border-2 border 
            ">
            {{ \Cart::subtotal() }}
            <div class="w-full 
                max-w-7xl mx-auto flex items-center 
