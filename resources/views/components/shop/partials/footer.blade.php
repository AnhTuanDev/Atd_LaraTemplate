<footer class="bg-primary-main" aria-labelledby="footer-heading">
        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div class="space-y-8 xl:col-span-1">
                <a href="/" class="
                         ...
                         lg:pr-8
                         "> Trillium Fashion </a>
                <p class="w-1/2 mt-2 text-base text-primary-text"> Một phong cách thời trang rất Trillfa </p>
            </div>
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul role="list" class="mt-4 space-y-4">
                            ...
                            <li>
                                <a href="#" class="text-base font-normal text-primary-text hover:text-gray-900"> Chinhs Sách đổi trả </a>
                            </li>
                        </ul>
                    </div>
                    <div class="mt-12 md:mt-0">
                        ...
                        <ul role="list" class="mt-4 space-y-4">
                            ...
                            <li>
                                <a href="#" class="text-base font-normal text-primary-text hover:text-gray-900"> Site Map </a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="hidden lg:justify-end md:grid md:grid-cols-1">
                    <div class="w-full mt-12 md:mt-0">
                        <div class="mt-8 lg:justify-end xl:mt-0">
                            ...
                            <p class="mt-4 text-base text-primary-text lg:ml-auto">
    ...
    <div class="bg-primary-dark">
        <div class="
            ...
            <div class="flex justify-center mb-8 space-x-6 md:order-last md:mb-0">
                <a href="#" class="text-gray-400 hover:text-primary-text">
            ...
            <div class="mt-8 md:mt-0 md:order-1">
                <span class="mt-2 text-base font-light text-primary-text"> 
                    Copyright © 2020 - 2021
                    <a href="https://trillfa.com" 
                        class="mx-2 text-wickedblue hover:text-primary-text" 
