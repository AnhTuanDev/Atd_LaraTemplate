<div class="flex flex-col mb-5 md:mb-8 overflow-hidden cursor-pointer p-2">
    ...
    <a href="{{ route('shop.product.show', $product) }}">
        <div class="flex-shrink-0 rounded-lg shadow-md border-2
                    border-primary-light group hover:ring-2
                    hover:ring-secondary-light hover:ring-opacity-50 
                    hover:shadow-lg hover:ring-offset-4 duration-200 ease-in-out">
                    <img class="object-cover w-full h-72 xl:h-96 rounded-lg group-hover:opacity-70 duration-200 ease-in" 
        ...
        <div class="flex-1">
            ...
            <a href="{{ route('shop.product.show', $product) }}" class="block mt-2 space-y-6">
                <h3 class="
                   ...
                   tracking-tighter text-secondary-dark
                   hover:text-primary-dark duration-150">{{ $product->name }}
                </h3>
            </a>
